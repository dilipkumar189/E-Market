...
export default function ATwoWheeler() {
  return (
    <div className="">
        <Header />
        <Sidebar />
        <div className='px-4 mt-3 sm:ml-64'>
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 border-[1px] rounded-lg shadow-sm ">
                <div className="grid grid-cols-9">
                    <h1 className="text-gray-600 font-bold text-lg mb-3 col-span-7 md:col-span-8">Two Wheeler</h1>
                    <div className="col-span-2 md:col-span-1 lg:ml-[20px]">
                    <Link to={"/dashboard/twowheeler_form"} className="btn btn-primary text-[9px] lg:text-[15px] font-bold px-[6px] py-[4px] rounded-[5px] ">
                        Add +
                    </Link>
                    </div>
                </div>
